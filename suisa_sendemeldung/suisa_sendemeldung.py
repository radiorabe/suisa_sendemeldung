...
erfolgen. Anschliessend gilt die Sendemeldung für $month als akzeptiert und die
...
def get_arguments(parser: ArgumentParser):  # pragma: no cover
    ...
    parser.add_argument(
        ...
        env_var="EMAIL_TEXT",
        help="""
        A template for the Email text, placeholders are $station_name, $month, $year, $previous_year, $responsible_email, and $mail_footer.
        """,
